...
const translations = {
  es: {
    ...
    feature_quality_desc: "Evalúa en tiempo real parámetros clave como pH y temperatura para garantizar agua segura.",
  ...
  en: {
    ...
    feature_quality_desc: "Track key water parameters like pH and temperature in real-time.",
